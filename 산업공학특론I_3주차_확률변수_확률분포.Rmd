...
dat$Target <- as.factor(dat$Target) # Target데이터 수치형 -> 범주형데이터로 변환
...
visualize <- function(x){
  if (is.factor(x)){ #데이터가 이산형인 경우엔 barplot으로 연속형인 경우 히스토그램
